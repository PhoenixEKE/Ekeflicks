...
class _ProfilePageState extends State<ProfilePage> {
  ...
  bool _isFinancialUser = true; // À modifier selon votre logique métier
  ...
  Widget _buildFinancialCodeField(AppLocalizations l10n) {
    return Column(
      ...
      children: [
            ...
            Expanded(
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: l10n.generateCodeHint,
        ...
        if (_generatedCode != null) ...[
          const SizedBox(height: 8),
          Text(
            l10n.codeValidForXMinutes.replaceAll('%d', '10'),
            style: const TextStyle(
