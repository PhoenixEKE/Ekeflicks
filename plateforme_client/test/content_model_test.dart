  ...
  group('Content', () {
    test('parses API detail including seasons, progress and next episode', () {
      final parsed = Content.fromJson({
        'id': 42, 'title': 'API series', 'type': 'series',
        'duration_seconds': 2700, 'genres': [{'name': 'Drame'}],
        'progress': 0.5, 'is_favorite': true, 'user_rating': 4,
        'seasons': [{'id': 1, 'season_number': 1, 'title': 'Saison 1', 'episodes': [
          {'id': 8, 'episode_number': 2, 'title': 'Retour', 'stream_url': '/e8.m3u8'}
        ]}],
        'next_episode': {'id': 9, 'episode_number': 3, 'title': 'Après', 'stream_url': '/e9.m3u8'},
      });
