...
class ProfilesApi {
  ...
  Future<Response<ProfileCreate>> profilesCreate({
    ...
    ProfileCreate? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProfileCreate),
      ) as ProfileCreate;
  ...
  Future<Response<ProfilesList200Response>> profilesList({
    ...
    ProfilesList200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProfilesList200Response),
      ) as ProfilesList200Response;
    ...
    return Response<ProfilesList200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
