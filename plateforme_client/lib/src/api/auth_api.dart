...
class AuthApi {
  ...
  Future<Response<void>> authLogoutAllCreate({ 
    ...
    try {
      const _type = FullType(AuthLogoutAllCreateRequest);
      _bodyData = _serializers.serialize(data, specifiedType: _type);
  ...
  Future<Response<void>> authLogoutCreate({ 
    ...
    try {
      const _type = FullType(AuthLogoutCreateRequest);
      _bodyData = _serializers.serialize(data, specifiedType: _type);
  ...
  Future<Response<PasswordResetConfirm>> authPasswordResetConfirmCreate({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PasswordResetConfirm),
  ...
  Future<Response<PasswordResetRequest>> authPasswordResetCreate({ 
    ...
    PasswordResetRequest? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PasswordResetRequest),
    ...
    return Response<PasswordResetRequest>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
