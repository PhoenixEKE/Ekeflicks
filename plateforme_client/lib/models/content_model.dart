...
class Season {
  ...
  factory Season.fromJson(Map<String, dynamic> json) => Season(
    id: '${json['id']}',
    number: _integer(json['number'] ?? json['season_number']),
    title: json['title']?.toString() ?? '',
...
class Content {
  ...
  factory Content.fromJson(Map<String, dynamic> json) {
    ...
    return Content(
      ...
      title: json['title']?.toString() ?? '',
      description:
          json['description']?.toString() ?? json['synopsis']?.toString() ?? '',
      imageUrl:
          json['image_url']?.toString() ??
          json['backdrop_url']?.toString() ??
          '',
      posterUrl:
          json['poster_url']?.toString() ?? json['image_url']?.toString() ?? '',
      ...
      userRating: _nullableDecimal(json['user_rating']),
      ageRating: json['age_rating']?.toString(),
      isHd: json['is_hd'] == true,
      progress: _nullableDecimal(json['progress']),
      cast:
          (json['cast'] as List?)
              ?.map(
                (e) => e is Map ? (e['name'] ?? '').toString() : e.toString(),
              ...
              .toList(),
      director:
          json['director'] is Map
              ? json['director']['name']?.toString()
              : json['director']?.toString(),
      episodeCount:
          json['episode_count'] == null
              ? null
              : _integer(json['episode_count']),
      seasons:
          json['season_count'] == null
              ? (seasonList.isEmpty ? null : seasonList.length)
              : _integer(json['season_count']),
      seasonInfo: json['season_info']?.toString(),
      seasonList: seasonList,
      isFavorite: json['is_favorite'] == true,
      nextEpisode:
          json['next_episode'] is Map
              ? Episode.fromJson(
