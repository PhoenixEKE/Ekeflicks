...
abstract class BaseAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  String getLogoPath(BuildContext context) {
    ...
    return isLight ? 'assets/images/logo_light.png' : 'assets/images/logo_dark.png';
  }
  ...
  Widget buildLanguageToggle(BuildContext context, AppLocalizations loc) {
    return IconButton(
      icon: Icon(Icons.language, size: 20, color: Theme.of(context).iconTheme.color),
...
class _HoverableLogoState extends State<HoverableLogo> with SingleTickerProviderStateMixin {
    ...
    return FocusableActionDetector(
      ...
      child: MouseRegion(
        ...
        child: AnimatedContainer(
          ...
          transform: (_isHovering || _isFocused)
              ? (Matrix4.identity()
                ..scale(1.1)
                ..rotateZ(0.015))
              : Matrix4.identity(),
