      ...
      _baseFooter.footerSection(
        ...
        childrenWidget: [
          Wrap(
            ...
            children: [
              _baseFooter.paymentIcon('assets/payments/visamaster.png'),
              _baseFooter.paymentIcon('assets/payments/moov.png'),
              _baseFooter.paymentIcon('assets/payments/mtn.png'),
              _baseFooter.paymentIcon('assets/payments/orange.png'),
              _baseFooter.paymentIcon('assets/payments/paypal.png'),
              _baseFooter.paymentIcon('assets/payments/wave.png'),
            ],
          ),
        ],
      ),
