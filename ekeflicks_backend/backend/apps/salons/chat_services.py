    ...
    *,
    ...
    if salon.host_id != user.pk:
        raise PermissionDenied(
            "Only the current host can moderate "
            "Salon messages."
        )
