...
class ProducerAnalyticsViewSet(viewsets.ViewSet):
    ...
    def content_detail(
        ...
        4. establish PostgreSQL ownership;
        5. only then query producer-scoped analytics.

        Foreign and unknown contents return 404 before
        either video or engagement analytics is called.
        """
        import uuid
        ...
        # PostgreSQL ownership is established before
        # either analytics service is allowed to run.
        from apps.analytics.services import (
