...
class VideoAssetViewSet(viewsets.ModelViewSet):
    ...
    def source_upload_session(self, request, pk=None):
        ...
        upload_url = minio_public_upload_client().generate_presigned_url(
